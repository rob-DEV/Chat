...
namespace Chat_Core
{
    public static class Constants
    {
        ...
        public static readonly string REQUEST_CLIENT_CHECK_CHAT_MESSAGE = "CLIENT_CHAT_CHECK_MESSAGE";
        ...
        public static readonly string RESPONSE_CLIENT_CHECK_CHAT_MESSAGE = "CLIENT_CHAT_MESSAGES";
